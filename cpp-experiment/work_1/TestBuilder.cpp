...
vector<TestBuilder> TestBuilder::testBuilderList = {};//待使用的出题者列表
...
void TestBuilder::AddWord()
{
	...
	ofstream outfile("wordList.csv", ios::out | ios::app);//如果没有文件，那么生成空文件；如果有文件，那么在文件尾追加
	if (!outfile) {
